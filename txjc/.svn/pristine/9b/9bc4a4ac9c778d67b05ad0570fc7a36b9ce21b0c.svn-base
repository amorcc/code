<template>
    <div style="padding-bottom:80px;">
        ...
        <div class="bg-white mt10 preview-submit">
            ...
            <div class="btn p0 b0">
                <input class="radius-none" v-on:click="storeOut(2)" type="button" value="出库并发货" />
                <input class="radius-none" v-on:click="storeOut(1)" type="button" value="出库" style="background:#cccccc;" />
            </div>
        </div>
        <div class="div-text mt10">
            <span class="red-line ml10">&nbsp;</span>
        ...
        storeOut: function (type) {
            ...
            this.fetchData({
                ...
                callback: function (data) {
                    if (type == 2) {
                        //出库并发货
                        me.$router.push({ path: '/deliver/' + me.orderCode });
                    }
                    else {
